...
```{r}
all_common_subsequences(str_to_tibble(hed_df$seg1[1])$char,
                        str_to_tibble(hed_df$seg2[1])$char)
```

```{r}
all_common_subsequences(str_to_tibble("asdsghjlkiopqwer")$char, 
                        str_to_tibble("lllllllghjjjjjjopqwerfffff")$char)
```
